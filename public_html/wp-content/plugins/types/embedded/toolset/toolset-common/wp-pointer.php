...
/**
* @todo DEPRECATED - this class can be removed
* - it is only loaded from Views up to version 1.10, it will not be required from Views 1.11
* - it is not being loaded  by any other Toolset plugin
* - it needs to go along with its assets
*/
