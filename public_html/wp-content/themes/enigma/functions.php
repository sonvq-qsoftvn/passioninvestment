	...
	function weblizar_default_settings()
{
	...
	*/
	...
	register_sidebar( array(
        ...
        register_sidebar( array(
			'name' => __( 'Header Widget Area', 'weblizar' ),
			'id' => 'header-widget-area',
			'description' => __( 'header widget area', 'weblizar' ),
			'before_widget' => '<div class="col-md-6 col-sm-12 enigma_header_widget_column">',
			'after_widget' => '</div>',
			'before_title' => '<div class="enigma_header_widget_title"><span class="header-title-underline">',
			'after_title' => '</span></div>',
		) );   
	}
