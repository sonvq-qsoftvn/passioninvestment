...
function of_recognized_background_repeat() {
	$default = array(
		...
		'repeat-x'  => __( 'Repeat Horizontally', 'onetone' ),
		'repeat-y'  => __( 'Repeat Vertically', 'onetone' ),
		'repeat'    => __( 'Repeat All', 'onetone' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		...
		'center left'   => __( 'Middle Left', 'onetone' ),
		'center center' => __( 'Middle Center', 'onetone' ),
		'center right'  => __( 'Middle Right', 'onetone' ),
...
function of_recognized_font_styles() {
	$default = array(
		...
		'italic'      => __( 'Italic', 'onetone' ),
		'bold'        => __( 'Bold', 'onetone' ),
		'bold italic' => __( 'Bold Italic', 'onetone' )
		);
